var categories = '''[
        ...
        },
        {
            "id": 34,
            "title": "Plastic Table",
            "description": "V﻿ery good quality plastic table for multi purpose now in reasonable priceD",
            "priceD": 50,
...
/*/* void storeCategoriesInFirebase(String jsonCategories) {
    List<dynamic> categories = json.decode(jsonCategories);

    CollectionReference categoriesCollection = FirebaseFirestore.instance.collection('products');
